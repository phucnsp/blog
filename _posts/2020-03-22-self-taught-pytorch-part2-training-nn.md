---
keywords: fastai
description: This notebook covers basic neural net training steps and analysing its prediction of a classification problem.
title: Pytorch part 2 - training neural net and analysing the result 
toc: true 
badges: true
comments: true
