---
keywords: fastai
description: This notebook will reuse functions from part 2 in order to train an CNN and then together we will see how to interpret the training's result. 
...
nb_path: _notebooks/2020-03-22-self-taught-pytorch-part3-training-nn.ipynb
layout: notebook
---
